...
public class LynxRecorderPageManager {
  ...
  private ArrayList<LynxRecorderActionCallback> mCallbacks;
  ...
  public void initLynxGroup(String groupName, LynxRecorderActivity currActivity) {
    ...
    LynxRecorderActivity activity = (LynxRecorderActivity) mGroups.opt(groupName);
    if (activity == null) {
      try {
  ...
  public void replayPageFromOpenSchema(ReadableMap params) {
    ...
    replayCurrPage((LynxRecorderActivity) mActivities.opt(currPageName), popLast);
  }
